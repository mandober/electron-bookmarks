...
const ack = (m, n, p) => {
    ...
    switch (p) {
        ...
        default:                            // hyperops p > 2
            if (n == 0) return m;
            else return ack(m-1, ack(m, n-1), p);
    }
...
const ackermann = curry((m, n, p) =>
    p === 0
        ...
        : p === 1
            ...
            : p === 2
                ? m ** n
                : ackermann(m-1, ackermann(m, n-1), p)
);
